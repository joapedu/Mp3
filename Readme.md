<h1 align="center">📖 College Project Part. 2📖</h1>
...
### Pegamos um projeto já feito de base.
...
- Para rodar o programa, utilize o comando a seguir. No arquivo selecionado, serão salvas as músicas e playlists para a próxima execução.
